...
interface SlimSearchKeyOptions {
    /**
...
type SlimSearchLocaleConfig = ExactLocaleConfig<SlimSearchLocaleData>;
...
export { type CustomFieldIndexID, type CustomFieldIndexItem, type CustomFieldOptions, IndexField, type IndexItem, type LocaleIndex, type PageIndexId, type PageIndexItem, type SearchIndexStore, type SectionIndexId, type SectionIndexItem, type SlimSearchCustomFieldFormatter, type SlimSearchIndexOptions, type SlimSearchKeyOptions, type SlimSearchLocaleConfig, type SlimSearchLocaleData, type SlimSearchPluginOptions, slimsearchPlugin };
